...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:block lg:w-5/12 relative overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center p-12">
          <div className="flex items-center gap-3 mb-10">
            <BookOpen size={30} className="text-white" strokeWidth={2.5} />
            <span className="font-display text-2xl font-bold text-white">BiblioDrop</span>
          </div>
          <h2 className="font-display text-4xl text-white leading-tight mb-4">
            Join thousands of readers across Bangladesh
          </h2>
          <p className="text-white/70 text-base leading-relaxed mb-10">
            Create an account and start exploring books. Delivered fresh to your doorstep.
          </p>
          <div className="space-y-4">
            {[
              'Browse 500+ books from local libraries',
              'Fast delivery within 2-3 business days',
              'Earn as a librarian by listing your books',
            ].map((item) => (
              <div key={item} className="flex items-center gap-3">
                <CheckCircle size={18} className="text-white shrink-0" fill="rgba(255,255,255,0.2)" />
      ...
      {/* Right — Form */}
      <div className="flex-1 flex items-center justify-center bg-base-200 px-4 py-12">
        <motion.div
          key={step}
